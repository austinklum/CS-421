...
public class Parser
{
    private final String methodRegex = "(int|void)\\s+[a-z]+\\s*\\(.*\\)\\s*\\{.*\\}.*";
    private final String programRegex = String.format("(.*)(%s)", methodRegex);
    private final Pattern programPattern = Pattern.compile(programRegex);
     ...
     */
    private String[] getParts(String programText)
    {
